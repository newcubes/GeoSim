...
void main() {
	...
	// MOSS horizontal movement
	// MOSS should only spread through AIR or gases (SMOKE, STEAM), not through solid materials
	bool moss01 = t01.a == MOSS && t11.a < MOSS;
	bool moss11 = t01.a < MOSS && t11.a == MOSS;
	bool mossCanSpread = (t00.a == AIR || t00.a == SMOKE || t00.a == STEAM) && 
	                     (t10.a == AIR || t10.a == SMOKE || t10.a == STEAM);
	...
	{
		if (t00.a < SAND && t00.a != WATER && t00.a != LAVA && t00.a != MOSS)
		{
		...
		else if (t11.a < SAND && t10.a < SAND && t11.a != MOSS && t10.a != MOSS)
		{
			swap(t01, t10);
		}
	}
	...
	{
		if (t10.a < SAND && t10.a != WATER && t10.a != LAVA && t10.a != MOSS)
		{
		...
		else if (t01.a < SAND && t00.a < SAND && t01.a != MOSS && t00.a != MOSS)
		{
			swap(t11, t00);
		}
	}
	...
	if (!drop)
	{
		...
		bool water01 = t01.a == WATER && t11.a < WATER;
		bool water11 = t01.a < WATER && t11.a == WATER;
		bool waterAbove = t00.a >= WATER && t10.a >= WATER;
		if ((water01 || water11) && (waterAbove || r.w < 0.8))
		{
			swap(t01, t11);
		}
		bool water00 = t00.a == WATER && t10.a < WATER;
		bool water10 = t00.a < WATER && t10.a == WATER;
		bool waterAboveN = tn00.a >= WATER && tn10.a >= WATER;
		if ((water00 || water10) && (waterAboveN || r.w < 0.8))
		{
			swap(t00, t10);
		}
	}
	...
	// ICE physics - melts near lava/fire, can fall like stone
	// ICE should behave like STONE - only fall through materials lighter than SAND
	if (t01.a == ICE)
	{
		// Check if near lava or fire
		bool nearHeat = (t00.a == LAVA || t00.a == FIRE || t10.a == LAVA || t10.a == FIRE || t11.a == LAVA || t11.a == FIRE);
		if (nearHeat && r.x < 0.05)
		{
			t01 = createParticle(WATER);
		}
		// ICE falls like stone - only through materials lighter than SAND (ID < 4)
...
vec3 getParticleColor(vec4 data)
{
	...
	if (data.a == AIR) {
		...
		// Use data.b for water level (brighter when hydrated) - same as plant
		return baseColor * (0.7 + data.b * 0.5);
	}
	// Default: return background color for unknown materials
	return bgColor;
}
